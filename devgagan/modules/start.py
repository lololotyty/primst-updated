...
async def set(_, message):
    ...
    await app.set_bot_commands([
        ...
        BotCommand("setwatermark", "💧 Set your watermark text"),
        BotCommand("clearwatermark", "🚫 Remove your watermark"),
        BotCommand("addwatermarkuser", "👥 Add watermark permission"),
        BotCommand("removewatermarkuser", "🚷 Remove watermark permission"),
...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://telegram.dog/shimps_bot")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "> 💰 **Premium Price**:\n\n Starting from $9 or 250 INR accepted via **__Amazon Gift Card__** (terms and conditions apply).\n"
...
async def see_plan(client, callback_query):
    plan_text = (
        "> 💰**Premium Price**\n\n Starting from $9 or 200 INR accepted via **__Amazon Gift Card__** (terms and conditions apply).\n"
        "📥 **Download Limit**: Users can download up to 100,000 files in a single batch command.\n"
        "🛑 **Batch**: You will get two modes /bulk and /batch.\n"
        "   - Users are advised to wait for the process to automatically cancel before proceeding with any downloads or uploads.\n\n"
