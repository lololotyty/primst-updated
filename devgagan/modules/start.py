...
async def set(_, message):
    ...
    await app.set_bot_commands([
        ...
        BotCommand("bot", "🤖 Get detailed information about bot link usage")
    ])
...
async def bot_help(_, message):
    help_text = (
        ...
        "• user must be a member of that bot\n\n"
         ...
         "🤖 **Private Chats & media Download Instructions**\n\n"
        "**1. Get the username of user with private messege id:**\n"
        "   • Copy the username (without @) and also get messege_id if do not find, contact support @SHIMPERD_BRO 😎\n\n"
        ...
        "⚠️ **Important Notes:**\n"
        "• The user must not block you\n\n"
        
        "🔒 **Above Premium Feature**\n\n"
